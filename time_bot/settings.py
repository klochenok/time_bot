"""
Django settings for time_bot project.
...
SECRET_KEY = '$@^mvfvdho4#kro-&2y1h!el!rl+scy!tmcm&d3_g2bldj4opw'
...
WSGI_APPLICATION = 'time_bot.wsgi.application'
